...
public class WorldGenMinableTutorial extends WorldGenerator
{
    ...
    public WorldGenMinableTutorial(int par1, int par2)
    {
        this(par1, par2, Main.TutorialStone.blockID);
    }

    public WorldGenMinableTutorial(int par1, int par2, int par3)
    {
    ...
    public WorldGenMinableTutorial(int id, int meta, int number, int target)
    {
