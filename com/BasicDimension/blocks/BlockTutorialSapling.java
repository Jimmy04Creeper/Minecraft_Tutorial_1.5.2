...
public class BlockTutorialSapling extends BlockFlower
{
	...
	public BlockTutorialSapling(int i, int j)
	{
		super(i);
		float var3 = 0.4F;
	...
	public void func_96477_c(World par1World, int par2, int par3, int par4, Random par5Random)
	{
		...
		if ((l & 8) == Main.TutorialGrass.blockID)
		{
	...
	protected boolean canThisPlantGrowOnThisBlockID(int par1)
	{
		...
		return par1 == Main.TutorialGrass.blockID || par1 == Block.dirt.blockID || par1 == Block.tilledField.blockID;
	}
}