...
public class BlockTutorialGrass extends Block
{
	...
	public BlockTutorialGrass(int par1)
	{
	...
	{
		this.blockIcon = par1IconRegister.registerIcon(Reference.MODID + ":" + "grassSide");
		this.iconGrassTop = par1IconRegister.registerIcon(Reference.MODID + ":" + "grassTop");
		this.iconGrassBottom = par1IconRegister.registerIcon(Reference.MODID + ":" + "grassBottom");
	}
}