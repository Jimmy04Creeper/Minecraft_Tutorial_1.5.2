...
public class BlockTutorialFire extends BlockFire
{
	...
	{
		this.blockIcon = par1IconRegister.registerIcon(Reference.MODID + ":" + "Tutorialfire_0");
		this.iconArray = new Icon[] { par1IconRegister.registerIcon(Reference.MODID + ":" + "Tutorialfire_0"), par1IconRegister.registerIcon(Reference.MODID + ":" + "Tutorialfire_1") };
	}
