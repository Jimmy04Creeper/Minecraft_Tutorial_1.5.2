...
public class BlockTutorialLog1 extends Block
{
	...
	public BlockTutorialLog1(int par1)
	{
	...
	public void registerIcons(IconRegister par1IconRegister)
	{
		...
		this.blockIcon = par1IconRegister.registerIcon(ReferenceMulti.MODID + ":" + "LogSide0");
		this.iconLogTop = par1IconRegister.registerIcon(ReferenceMulti.MODID + ":" + "LogTop0");
		this.iconLogBottom = par1IconRegister.registerIcon(ReferenceMulti.MODID + ":" + "LogTop0");
	}
