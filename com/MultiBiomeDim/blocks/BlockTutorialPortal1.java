...
import com.MultiBiomeDim.world.TutorialTeleporter1;
...
public class BlockTutorialPortal1 extends BlockBreakable
{
	public BlockTutorialPortal1(int par1)
	{
		super(par1, ReferenceMulti.MODID + ":" + "TutorialPortal", Material.portal, false);
	...
	public boolean tryToCreatePortal(World par1World, int par2, int par3, int par4)
	{
		...
		else
		{
			...
			for (l = -1; l <= 2; ++l)
			{
				for (i1 = -1; i1 <= 3; ++i1)
				{
					...
					if (l != -1 && l != 2 || i1 != -1 && i1 != 3)
					{
						...
						else if (j1 != 0 && j1 != Main.TutorialFire1.blockID)
						{
							return false;
						}
					}
			...
			for (l = 0; l < 2; ++l)
			{
				for (i1 = 0; i1 < 3; ++i1)
				{
					par1World.setBlock(par2 + b0 * l, par3 + i1, par4 + b1 * l, Main.TutorialPortal1.blockID, 0, 2);
				}
			}
			return true;
		}
	...
	public void onEntityCollidedWithBlock(World par1World, int par2, int par3, int par4, Entity par5Entity)
	{
		if ((par5Entity.ridingEntity == null) && (par5Entity.riddenByEntity == null) && ((par5Entity instanceof EntityPlayerMP)))
		{
			...
			{
				thePlayer.timeUntilPortal = 10;
				thePlayer.mcServer.getConfigurationManager().transferPlayerToDimension(thePlayer, Main.DimID, new TutorialTeleporter1(thePlayer.mcServer.worldServerForDimension(Main.DimID)));
			}
			else {
				thePlayer.timeUntilPortal = 10;
				thePlayer.mcServer.getConfigurationManager().transferPlayerToDimension(thePlayer, 0, new TutorialTeleporter1(thePlayer.mcServer.worldServerForDimension(0)));
			}
		}
	}
