...
import com.MultiBiomeDim.world.gen.layer.GenLayerTutorial;
...
public class WorldChunkMangerTutorialTest extends WorldChunkManager
{
	...
	protected WorldChunkMangerTutorialTest()
	{
		...
		this.myBiomesToSpawnIn.add(Main.TutorialBiome1);
	...
	public BiomeGenBase[] getBiomesForGeneration(BiomeGenBase[] par1ArrayOfBiomeGenBase, int par2, int par3, int par4, int par5) {
		...
		for (int i = 0; i < par4 * par5; ++i) {
			if (aint[i] >= 0) {
				...
				par1ArrayOfBiomeGenBase[i] = Main.TutorialBiome1;
			}
		}
