...
public class WorldProviderTutorial1 extends WorldProvider
{
	private float[] colorsSunriseSunset = new float[4];
	public void registerWorldChunkManager()
	{
		this.worldChunkMgr = new WorldChunkManagerHell(Main.TutorialBiome1, this.dimensionId, this.dimensionId);
		this.dimensionId = DimensionIDsMulti.DIMID_2;
		this.hasNoSky = false;
	}
	public IChunkProvider createChunkGenerator()
	{
		return new ChunkProviderTutorial1(this.worldObj, this.worldObj.getSeed(), false);
	}
	...
	{
		if ((this instanceof WorldProviderTutorial1))
		{
