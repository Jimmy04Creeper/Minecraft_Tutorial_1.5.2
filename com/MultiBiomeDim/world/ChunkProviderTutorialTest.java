...
public class ChunkProviderTutorialTest implements IChunkProvider {
	/** RNG. */
	private Random rand;
	...
	public ChunkProviderTutorialTest(World world, long seed, boolean mapFeaturesEnabled) {
		this.worldObj = world;
	...
	public void populate(IChunkProvider par1IChunkProvider, int par2, int par3) {
        ...
        for (int c = 60; c > 0; c--)
        {
                ...
                if ((worldObj.getBlockId(j2, l3, j5) == 0) && (worldObj.getBlockId(j2, l3 - 1, j5) == Main.TutorialGrass.blockID))
                {
                        new WorldGenTutorialTree(true, 6 + rand.nextInt(8), 0, 0, false).generate(worldObj, rand, j2, l3, j5);
                }
        }
        for (int c = 50; c > 0; c--)
        {
                ...
                if ((worldObj.getBlockId(j2, l3, j5) == 0) && (worldObj.getBlockId(j2, l3 - 1, j5) == Main.TutorialGrass.blockID))
                {
                        new WorldGenTutorialTree(true, 4 + rand.nextInt(8), 0, 0, false).generate(worldObj, rand, j2, l3, j5);
                }
        }
        for (int c = 50; c > 0; c--)
        {
                ...
                if ((worldObj.getBlockId(j2, l3, j5) == 0) && (worldObj.getBlockId(j2, l3 - 1, j5) == Main.TutorialGrass.blockID))
                {
                        new WorldGenTutorialTree(true, 8 + rand.nextInt(8), 0, 0, false).generate(worldObj, rand, j2, l3, j5);
                }
        }
        for (int c = 50; c > 0; c--)
        {
                ...
                if ((worldObj.getBlockId(j2, l3, j5) == 0) && (worldObj.getBlockId(j2, l3 - 1, j5) == Main.TutorialGrass.blockID))
                {
                        new WorldGenTutorialTree(true, 10 + rand.nextInt(8), 0, 0, false).generate(worldObj, rand, j2, l3, j5);
                }
        }
        for (int c = 50; c > 0; c--)
        {
                ...
                if ((worldObj.getBlockId(j2, l3, j5) == 0) && (worldObj.getBlockId(j2, l3 - 1, j5) == Main.TutorialGrass.blockID))
                {
                        new WorldGenTutorialTree(true, 15 + rand.nextInt(4), 0, 0, false).generate(worldObj, rand, j2, l3, j5);
                }
        }
        for (int c = 60; c > 0; c--)
        {
        ...
        for (int c = 60; c > 0; c--)
        {
                ...
                if ((worldObj.getBlockId(j2, l3, j5) == 0) && (worldObj.getBlockId(j2, l3 - 1, j5) == Main.TutorialGrass.blockID))
                {
                        new WorldGenTutorialForestTree(true).generate(worldObj, rand, j2, l3, j5);
                }
        }
        ...
        for (int c = 60; c > 0; c--)
        {
                ...
                if ((worldObj.getBlockId(j2, l3, j5) == 0) && (worldObj.getBlockId(j2, l3 - 1, j5) == Main.TutorialGrass.blockID))
                {
                        new WorldGenTutorialHugeTree(true, 15 + rand.nextInt(8), 0, 0).generate(worldObj, rand, j2, l3, j5);
                }
        }
