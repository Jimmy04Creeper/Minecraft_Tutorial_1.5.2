...
public class ChunkProviderTutorial1 implements IChunkProvider
{
	private Random rand;
	...
	public ChunkProviderTutorial1(World par1World, long par2, boolean par4) {
						...
						for (int i2 = 0; i2 < 4; ++i2)
						{
							...
							for (int k2 = 0; k2 < 4; ++k2)
							{
								if ((d16 += d15) > 0.0D)
								{
									...
									par3ArrayOfByte[j2 += short1] = (byte)Main.TutorialStone1.blockID;//
								}
								else if (k1 * 8 + l1 < b2)
								{
			...
			for (int var9 = 0; var9 < 16; var9++)
			{
				...
				for (int var16 = 127; var16 >= 0; var16--)
				{
					...
					else
					{
						...
						/** Main filler block fill's all the underground, replaces block stone **/
						else if (var18 != Main.TutorialStone1.blockID)
						{
							if (var13 == -1)
							{
								if (var12 == 0)
								{
									...
									var15 = (byte)Main.TutorialDirt1.blockID;//
								}
	...
	public void populate(IChunkProvider par1IChunkProvider, int par2, int par3)
	{
        ...
        for (int c = 60; c > 0; c--)
        {
                ...
                if ((worldObj.getBlockId(j2, l3, j5) == 0) && (worldObj.getBlockId(j2, l3 - 1, j5) == Main.TutorialGrass1.blockID))
                {
                        new WorldGenTutorialTree1(true, 6 + rand.nextInt(8), 0, 0, false).generate(worldObj, rand, j2, l3, j5);
                }
        }
        for (int c = 50; c > 0; c--)
        {
                ...
                if ((worldObj.getBlockId(j2, l3, j5) == 0) && (worldObj.getBlockId(j2, l3 - 1, j5) == Main.TutorialGrass1.blockID))
                {
                        new WorldGenTutorialTree1(true, 4 + rand.nextInt(8), 0, 0, false).generate(worldObj, rand, j2, l3, j5);
                }
        }
        for (int c = 50; c > 0; c--)
        {
                ...
                if ((worldObj.getBlockId(j2, l3, j5) == 0) && (worldObj.getBlockId(j2, l3 - 1, j5) == Main.TutorialGrass1.blockID))
                {
                        new WorldGenTutorialTree1(true, 8 + rand.nextInt(8), 0, 0, false).generate(worldObj, rand, j2, l3, j5);
                }
        }
        for (int c = 50; c > 0; c--)
        {
                ...
                if ((worldObj.getBlockId(j2, l3, j5) == 0) && (worldObj.getBlockId(j2, l3 - 1, j5) == Main.TutorialGrass1.blockID))
                {
                        new WorldGenTutorialTree1(true, 10 + rand.nextInt(8), 0, 0, false).generate(worldObj, rand, j2, l3, j5);
                }
        }
        for (int c = 50; c > 0; c--)
        {
                ...
                if ((worldObj.getBlockId(j2, l3, j5) == 0) && (worldObj.getBlockId(j2, l3 - 1, j5) == Main.TutorialGrass1.blockID))
                {
                        new WorldGenTutorialTree1(true, 15 + rand.nextInt(4), 0, 0, false).generate(worldObj, rand, j2, l3, j5);
                }
        }
        for (int c = 60; c > 0; c--)
        {
        ...
        for (int c = 60; c > 0; c--)
        {
                ...
                if ((worldObj.getBlockId(j2, l3, j5) == 0) && (worldObj.getBlockId(j2, l3 - 1, j5) == Main.TutorialGrass1.blockID))
                {
                        new WorldGenTutorialForestTree1(true).generate(worldObj, rand, j2, l3, j5);
                }
        }
        ...
        for (int c = 60; c > 0; c--)
        {
                ...
                if ((worldObj.getBlockId(j2, l3, j5) == 0) && (worldObj.getBlockId(j2, l3 - 1, j5) == Main.TutorialGrass1.blockID))
                {
                        new WorldGenTutorialHugeTree1(true, 15 + rand.nextInt(8), 0, 0).generate(worldObj, rand, j2, l3, j5);
                }
        }
